    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            ...
            <div class="container">
                ...
                <p><a href="añadir.php" class="btn btn-primary my-2">Crear Estudiante &nbsp;&nbsp;&nbsp; <i
                ...
                <div style="margin-bottom: 3%;" class="row">
                    ...
                    <div class="col-md-3">
                        <div class="btn-group">
                            ...
                            <a href="index.php" class="btn btn-outline-primary">Todos &nbsp; <i
                                    class="far fa-user"></i></a>

                            <a href="index.php?carreraid=2" class="btn btn-outline-secondary">Software &nbsp;<i
                                    class="fas fa-laptop-code"></i></a>

                            <a href="index.php?carreraid=3" class="btn btn-outline-warning">Seguridad &nbsp; <i
                                    class="fas fa-cloud"></i></a>

                            <a href="index.php?carreraid=7" class="btn btn-outline-info">Sonido &nbsp;<i
